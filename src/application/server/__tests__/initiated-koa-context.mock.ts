import { IInitiatedKoaContext } from '../../../../__legacy/src/adapters/controllers/koa-controller';
...
export const createMockOfInitiatedKoaContext = (
    overrideParams?: Partial<IInitiatedKoaContext> | { response: any } | { request: any },
    withAuthenticatedUser = false,
): IInitiatedKoaContext => {
    return {
        ...createMockContext(),
        authenticatedUser: withAuthenticatedUser ? createMockOfUserEntity() : undefined,
        logout: jest.fn(),
