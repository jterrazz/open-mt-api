...
import { createMockOfLogger } from '@application/../../../__mocks__/logger.mock';
import { createMockOfUserEntity } from '@domain/use-cases/user/__mocks__/user-entity.mock';
import { createMockOfUserRepository } from '@domain/use-cases/user/__mocks__/user-repository.mock';
