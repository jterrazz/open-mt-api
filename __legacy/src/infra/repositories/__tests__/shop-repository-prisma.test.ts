...
describe('ShopRepositoryPrisma', function () {
    describe('add()', function () {
        ...
        test('throws if the user already has a shop', async () => {
            ...
            // Then
            await expect(ft).rejects.toBeInstanceOf(BrokenOneToOneRelationServerError);
    ...
    describe('update()', function () {
        ...
        test('updates the data of a shop', async () => {
            // Given
            const { shop: seededShop, user: seededUser } = await seedDatabaseWithShop(
                databaseClient,
            );
            const updatedShopData = createMockOfUpdatedShopData();

            // When
            const result = await repository.update(updatedShopData, seededShop.id);
    ...
    describe('findByHandle()', function () {
        test('returns entity of an existing shop', async () => {
            ...
            // When
            const result = await repository.findByHandle('shop_repository_prisma_handle');
    ...
    describe('findByOwnerId()', function () {
        test('returns entity of an existing shop', async () => {
            ...
            // When
            const result = await repository.findByOwnerId(globallySeededUser.id);
