...
const mapPersistedProductToProductEntity = (persistedProduct: Product): ProductEntity => ({
...
export const productRepositoryPrismaFactory = (prismaClient: PrismaClient): IProductRepository => ({
    ...
    findByProductId: async (id) => {
        ...
        return persistedProduct && mapPersistedProductToProductEntity(persistedProduct);
    },
