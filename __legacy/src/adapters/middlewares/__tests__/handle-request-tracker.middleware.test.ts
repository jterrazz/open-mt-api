...
import { handleRequestTrackerMiddlewareFactory } from '../handle-request-tracker.middleware';
...
describe('handleRequestTrackerMiddleware()', () => {
    ...
    test('handles the lifecycle of a request', async () => {
        ...
        // When
        await handleRequestTrackerMiddlewareFactory(initTrackerForRequest)(ctx, next);
